...
@section('content_header')
    ...
    <div class="row">
        <h1>regimen</h1> 
        <a href="{{url('/regimen/create')}}" class="btn btn-primary">Nuevo</a>
    </div>
    ...
    <x-adminlte-datatable id="table1" :heads="$heads" :config="$config">
        @foreach($regimenes as $regimen)
            <tr>
                ...
                <td>
                    <div class="row">
                    <a href="{{ url('/regimen/'.$regimen->id.'/edit')}}" class="btn btn-xs btn-default text-primary mx-1 shadow" title="Editar"><i class="fa fa-lg fa-fw fa-pen"></i></a>
